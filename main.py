...
class UFO(pygame.sprite.Sprite):
    ...
    def __init__(self, *group, border, x, y, bullets=None):
        super().__init__(*group)
        self.bullets = bullets
        self.group = group
...
class BulletOfEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self, *group, enemy=None, angle=None):
        super().__init__(*group)
...
def win_screen(ship):
    ...
    while running:
        ...
        if winsc.stop:
            ...
            skills = [f'Здоровье: {ship.health}                  (+1)', f'Наличие щита: {ship.shield}',
                      f'Скорость снаряда: {Bullet.speed}     (+2)']
            font = pygame.font.SysFont('comicsansms', 30)
